...
ALTER TABLE CHITIETTHELOAI ADD CONSTRAINT FK_CHITIETTHELOAI_PHIM FOREIGN KEY (IDPHIM) REFERENCES PHIM(ID) ON DELETE CASCADE;
ALTER TABLE CHITIETTHELOAI ADD CONSTRAINT FK_CHITIETTHELOAI_THELOAI FOREIGN KEY (IDTHELOAI) REFERENCES THELOAI(ID);
ALTER TABLE PHIMLE ADD CONSTRAINT FK_PHIMLE_PHIM FOREIGN KEY (IDPHIM) REFERENCES PHIM(ID) ON DELETE CASCADE;
ALTER TABLE PHIMBO ADD CONSTRAINT FK_PHIMbO_PHIM FOREIGN KEY (IDPHIM) REFERENCES PHIM(ID) ON DELETE CASCADE;
ALTER TABLE CHITIETDAODIEN ADD CONSTRAINT FK_CHITIETDAODIEN_PHIM FOREIGN KEY (IDPHIM) REFERENCES PHIM(ID) ON DELETE CASCADE;
ALTER TABLE DAODIEN ADD CONSTRAINT FK_DAODIEN_NGUOI FOREIGN KEY (IDDAODIEN) REFERENCES NGUOI(ID);
ALTER TABLE DIENVIEN ADD CONSTRAINT FK_DIENVIEN_NGUOI FOREIGN KEY (IDDIENVIEN) REFERENCES NGUOI(ID);
...
ALTER TABLE CHITIETDIENVIEN ADD CONSTRAINT FK_CHITIETDIENVIEN_PHIM FOREIGN KEY (IDPHIM) REFERENCES PHIM(ID) ON DELETE CASCADE;
ALTER TABLE CHITIETQUOCGIA ADD CONSTRAINT FK_CHITIETQUOCGIA_PHIM FOREIGN KEY (IDPHIM) REFERENCES PHIM(ID) ON DELETE CASCADE;
ALTER TABLE CHITIETQUOCGIA ADD CONSTRAINT FK_CHITIETQUOCGIA_QUOCGIA FOREIGN KEY (IDQUOCGIA) REFERENCES QUOCGIA(ID);
ALTER TABLE PHIMDECU ADD CONSTRAINT FK_PHIMDECU_PHIM FOREIGN KEY (IDPHIM) REFERENCES PHIM(ID) ON DELETE CASCADE;
ALTER TABLE COMMENT ADD CONSTRAINT FK_COMMENT_USER FOREIGN KEY (EMAIL) REFERENCES USER(EMAIL);
ALTER TABLE COMMENT ADD CONSTRAINT FK_COMMENT_PHIM FOREIGN KEY (IDPHIM) REFERENCES PHIM(ID) ON DELETE CASCADE;
ALTER TABLE CHITIETDANHGIA ADD CONSTRAINT FK_CHITIETDANHGIA_PHIM FOREIGN KEY (IDPHIM) REFERENCES PHIM(ID) ON DELETE CASCADE;
...
INSERT INTO PHIMDECU VALUES (15),(16), (17), (18), (19);
# SELECT * FROM USER;
# SELECT * FROM PHIM;
